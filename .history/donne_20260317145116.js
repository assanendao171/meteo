...
btn.addEventListener("click", function () {
  ...
  capital.textContent=` ☀️ : région géographique `
drapeau.textContent=` 🌡️ Température `
monnaie.textContent=` ☁️ : Neige `
langue.textContent=` 🌦️ : Bruine  `
population.textContent=` 💨 : Vent `
});
